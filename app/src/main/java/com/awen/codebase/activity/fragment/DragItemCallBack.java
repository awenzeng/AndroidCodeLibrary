...
public class DragItemCallBack extends ItemTouchHelper.Callback {
    ...
    public DragItemCallBack(DragRecyclerViewAdapter adapter, List<String> images, List<String> originImages) {
    ...
    public void onChildDraw(Canvas c, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
        ...
        if (dY >= recyclerView.getHeight() - viewHolder.itemView.getBottom()) {//item底部距离recyclerView顶部高度
