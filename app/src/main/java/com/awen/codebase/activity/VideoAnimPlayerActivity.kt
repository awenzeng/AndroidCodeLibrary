...
import kotlinx.android.synthetic.main.act_video_anim_player.*
import java.io.File
...
class VideoAnimPlayerActivity : BaseActivity(), IAnimListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setActivityContentView(R.layout.act_video_anim_player)
        // 文件加载完成后会调用init方法
        loadFile()
    }
    ...
    private fun play(videoInfo: VideoInfo) {
        ...
        Thread {
            ...
            val md5 = AssetsFileUtil.getFileMD5(file)
    ...
    private fun loadFile() {
        ...
        AssetsFileUtil.copyAssetsToStorage(this, dir, files) {
            uiHandler.post {
                init()
            }
        }
