...
public class RotateActivity extends Activity implements OnTouchListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        initMain();
        RotateAnimations.initOffset(this);


        // 加号的动画
        composerButtonsShowHideButton.startAnimation(RotateAnimations.getRotateAnimation(0, 360, 200));
        ...
        composerButtonsShowHideButton.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                if (!areButtonsShowing) {
                    // 图标的动画
                    RotateAnimations.startAnimationsIn(composerButtonsWrapper, 300);
                    // 加号的动画
                    composerButtonsShowHideButtonIcon.startAnimation(RotateAnimations.getRotateAnimation(0, -225, 300));
                } else {
                    // 图标的动画
                    RotateAnimations.startAnimationsOut(composerButtonsWrapper, 300);
                    // 加号的动画
                    composerButtonsShowHideButtonIcon.startAnimation(RotateAnimations.getRotateAnimation(-225, 0, 300));
                }
        ...
        for (int i = 0; i < composerButtonsWrapper.getChildCount(); i++) {
            ...
            smallIcon.setOnClickListener(new View.OnClickListener() {
                public void onClick(View arg0) {
                    ...
                    if (areButtonsShowing) {
                        composerButtonsShowHideButtonIcon.startAnimation(RotateAnimations.getRotateAnimation(-225, 0, 300));
                        smallIcon.startAnimation(RotateAnimations.getMaxAnimation(400));
                        for (int j = 0; j < composerButtonsWrapper.getChildCount(); j++) {
                            if (j != position) {
                                ...
                                smallIcon.startAnimation(RotateAnimations.getMiniAnimation(300));
    ...
    private void initMain() {
        setContentView(R.layout.act_rotate);
