...
import com.awen.codebase.model.plugin.PluginViewManager;
...
public class PluginActivity extends BaseActivity {
    ...
    private LinearLayout mPluginContentView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setActivityContentView(R.layout.act_plugin);
        mPluginContentView = findViewById(R.id.plugin_contentView);
        load(null);
    }
    ...
    public void addPlugin(View view) {
        mPluginContentView.addView(PluginViewManager.getPluginView(this,PluginManager.getInstance().getResources()));
    }
}
