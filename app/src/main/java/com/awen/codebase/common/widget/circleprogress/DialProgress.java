package com.awen.codebase.common.widget.circleprogress;
...
public class DialProgress extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        mContext = context;
        mDefaultSize = ScreenSizeUtil.dipToPx(context, CircleConstant.DEFAULT_SIZE);
        mRectF = new RectF();
    ...
    private void initConfig(Context context, AttributeSet attrs) {
        ...
        mMaxValue = typedArray.getFloat(R.styleable.DialProgress_maxValue, CircleConstant.DEFAULT_MAX_VALUE);
        mValue = typedArray.getFloat(R.styleable.DialProgress_value, CircleConstant.DEFAULT_VALUE);
        mValueSize = typedArray.getDimension(R.styleable.DialProgress_valueSize, CircleConstant.DEFAULT_VALUE_SIZE);
        ...
        mPrecisionFormat = ScreenSizeUtil.getPrecisionFormat(precision);
        ...
        mUnitSize = typedArray.getDimension(R.styleable.DialProgress_unitSize, CircleConstant.DEFAULT_UNIT_SIZE);
        ...
        mHintSize = typedArray.getDimension(R.styleable.DialProgress_hintSize, CircleConstant.DEFAULT_HINT_SIZE);

        mArcWidth = typedArray.getDimension(R.styleable.DialProgress_arcWidth, CircleConstant.DEFAULT_ARC_WIDTH);

        mStartAngle = typedArray.getFloat(R.styleable.DialProgress_startAngle, CircleConstant.DEFAULT_START_ANGLE);
        mSweepAngle = typedArray.getFloat(R.styleable.DialProgress_sweepAngle, CircleConstant.DEFAULT_SWEEP_ANGLE);

        mAnimTime = typedArray.getInt(R.styleable.DialProgress_animTime, CircleConstant.DEFAULT_ANIM_TIME);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(ScreenSizeUtil.measure(widthMeasureSpec, mDefaultSize),
                ScreenSizeUtil.measure(heightMeasureSpec, mDefaultSize));
    }
    ...
    private float getBaselineOffsetFromY(Paint paint) {
        return ScreenSizeUtil.measureTextHeight(paint) / 2;
    }
