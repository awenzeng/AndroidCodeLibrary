...
public class WaveProgress extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mDarkWaveAnimTime = typedArray.getInt(R.styleable.WaveProgress_darkWaveAnimTime, CircleConstant.DEFAULT_ANIM_TIME);
        mLightWaveAnimTime = typedArray.getInt(R.styleable.WaveProgress_lightWaveAnimTime, CircleConstant.DEFAULT_ANIM_TIME);
        mMaxValue = typedArray.getFloat(R.styleable.WaveProgress_maxValue, CircleConstant.DEFAULT_MAX_VALUE);
        mValue = typedArray.getFloat(R.styleable.WaveProgress_value, CircleConstant.DEFAULT_VALUE);
        mValueSize = typedArray.getDimension(R.styleable.WaveProgress_valueSize, CircleConstant.DEFAULT_VALUE_SIZE);
        ...
        mHintSize = typedArray.getDimension(R.styleable.WaveProgress_hintSize, CircleConstant.DEFAULT_HINT_SIZE);

        mCircleWidth = typedArray.getDimension(R.styleable.WaveProgress_circleWidth, CircleConstant.DEFAULT_ARC_WIDTH);
        ...
        mWaveHeight = typedArray.getDimension(R.styleable.WaveProgress_waveHeight, CircleConstant.DEFAULT_WAVE_HEIGHT);
    ...
    private Point[] getPoint(boolean isR2L, float waveWidth) {
        ...
        return isR2L ? ScreenSizeUtil.reverse(points) : points;
    }
