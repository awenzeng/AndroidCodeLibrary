...
import com.awen.codebase.activity.adapter.MiLaucherAdapter;
import com.awen.codebase.common.data.Configure;


public class MiLaucherDragGrid extends GridView {
	...
	public MiLaucherDragGrid(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public MiLaucherDragGrid(Context context) {
		super(context);
	}
	...
	private void onDrop(int x, int y) {
		...
		final MiLaucherAdapter adapter = (MiLaucherAdapter)this.getAdapter();
		if(dragPosition%2 == 0){
